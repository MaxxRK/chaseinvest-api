...
response = chase.session.post(url="https://secure.chase.com/svc/rr/accounts/secure/v2/portfolio/account/options/list", data=data)
print(response)
print(response.text)
data = {
    "currencyCode": "",
...
response = chase.session.post(url="https://secure.chase.com/svc/wr/dwm/secure/gateway/investments/servicing/inquiry-maintenance/digital-investment-positions/v1/positions", json=data)
print(response)
print(response.text)